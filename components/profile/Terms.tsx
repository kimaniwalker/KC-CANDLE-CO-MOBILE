            ...
            <ScrollView>
                ...
                <Wrapper>
                    <Content>
                        ...
                        <Description><Bold>Shipping:</Bold> Each package will be shipped from our local post office and could be subject delays. If you encounter any issues with your package, please reach out to us via our email <Bold>admin@kustomcharmz.com</Bold> and we will respond within 48 hours. If you receive any broken packages , please send us an email with a picture of the items and we will replace asap.</Description>
                    </Content>
                </Wrapper>
            </ScrollView>
