            ...
            <ScrollView>
                ...
                <Wrapper>
                    <Content>
                        ...
                        <Description><Bold>Memberships:</Bold> Memberships are open to join at any time and can only be done on the KCCANDLECO website or mobile app. Before you purchase your membership please read the rules of the membership guidelines as breaking them will result in a loss of membership. Memberships are available in monthly or yearly increments. </Description>
                        <Description><Bold>What to expect:</Bold> After signing up successfully for a subscription package you will be charged on a monthly basis UNLESS you pay up front by signing up for the full year.  For monthly plans , you will be charged on the same day of each month. Ex. If you sign up on Jan 15th , you will be charged again on Feb 15th. You will be able to see all of this information under the accounts tab by selecting subscription details. In the accounts tab , you will notice a section labeled upcoming schedule which shows your upcoming candle for each month. If you have one that is your favorite or would like to try a new one , you can edit the calendar here and make a selection. In order to accommodate any last minute updates, changes need to be saved by the first of the month. All orders will began processing at the first of each month. </Description>
                        <Description><Bold>Cancellation Policy:</Bold> You can cancel a subscription at any time. This can be done via the accounts tab under subscription details. The cancellation will take place immediately and you will be mailed any items that you are owed for the current billing period. For yearly subscriptions , your account will remain active throughout the length of the year and you will not be auto enrolled for the next year. This means that you will still receive your monthly packages until the term is over. </Description>
                        ...
                        <Description><Bold>Shipping:</Bold> Each package will be shipped from our local post office and could be subject to delays. If you encounter any issues, please reach out to us via our email <Bold>admin@kustomcharmz.com</Bold> and we will respond within 48 hours. If you receive any broken packages , please send us an email with a picture of the items and we will replace them asap.</Description>
                    </Content>
                </Wrapper>
            </ScrollView>
